...
// export const requestDataCountryCovid = () => ({ type: REQUEST_DATA_COUNTRY_COVID })
// export const receiveDataCountryCovid = data => ({ type: RECEIVE_DATA_COUNTRY_COVID, payload: data })
