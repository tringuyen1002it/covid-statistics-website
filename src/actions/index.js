...
export const REQUEST_DATA_COVID_MAP = "REQUEST_DATA_COVID_MAP"
export const RECEIVE_DATA_COVID_MAP = "RECEIVE_DATA_COVID_MAP"
...
export const requestDataCovidMap = () => ({ type: REQUEST_DATA_COVID_MAP })
export const receiveDataCovidMap = data => ({ type: RECEIVE_DATA_COVID_MAP, payload: data })